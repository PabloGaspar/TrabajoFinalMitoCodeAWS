...
import com.cursomito.lenguajepreferencia.security.AwsCognitoJwtAuthenticationFilter;
import com.cursomito.lenguajepreferencia.security.AwsCognitoRSAKeyProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public JWTVerifier beanJWTVerifier() throws IOException {
		...
		JWTVerifier jwtVerifier = JWT.require(algorithm)
			.acceptLeeway(30)   //1 sec for nbf and iat
			.acceptExpiresAt(30)   //5 secs for exp
